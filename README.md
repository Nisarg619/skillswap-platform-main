...
A full-stack web application designed to connect individuals who want to exchange knowledge and skills with each other. This platform includes user authentication, profile management, a comprehensive swap request system, and an admin panel for platform management.
...
The Skill Swap Platform creates a community where individuals can exchange knowledge and skills. Users can create detailed profiles, list skills they can offer, and skills they wish to learn. The platform enables users to browse other users' profiles, send skill swap requests, and provide feedback on completed exchanges. An administrative interface provides tools for user management, monitoring swap requests, and issuing platform-wide announcements.

## Features

* **User Authentication:** Secure signup and login system for users.
* **User Profiles:**
    * Personalized profiles with name, location, bio, and skills.
    * Ability to list skills offered and skills wanted.
    * Availability settings for scheduling.
    * Profile photo upload (via URL or file).
    * Option to make profile public or private.
    * Customizable themed UI based on user preference.
* **Browse Users:** Discover other users and their skills with search and filtering capabilities.
* **Swap Requests:** Send and manage requests to exchange skills with other users.
* **Google Meet Integration:** Automatic generation of meeting links when requests are accepted.
* **Notification System:** Real-time notifications for new requests and status updates.
